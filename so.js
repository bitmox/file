            ...
            var _directSource       = 'aHR0cHM6Ly82ZDQyYTQ5Zi53dXJsLmNvbS9tYXN0ZXIvZjM2ZDI1ZTdlNTJmMWJhOGQ3ZTU2ZWI4NTljNjM2NTYzMjE0ZjU0MS9VMkZ0YzNWdVp5MXBkRjlHU1VaQlVHeDFjMTlJVEZNL3BsYXlsaXN0Lm0zdTg';
            var _loopCounter        = 0;
            ...
            var _rebuildPlayer = function(_source, _target, _event){    
                ...
                //_changeState('test ajah', 'test.html');
                //console.clear();
                ...
                if(_jsonData.yt_url != '' && typeof _jsonData.yt_url != 'undefined'){
                    ...
                    var _embedHtml          = '<iframe id="shaka_player_iframe" width="100%" height="100%" src="'+_frameUrl+'" title="Duktek Sports - Duktek TV" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
                    ...
                    $('#embed_youtube').html(_embedHtml);                           
                    $('#embed_youtube').show();
                } else if(_jsonData.jenis == 'hls'){       
                    playerInstance.setup({
                        playlist: [{
                            "image": "https://cdn.jsdelivr.net/gh/bitmox/file@main/promintonx.png",
                ...
                } else if(_jsonData.jenis == 'mobiles'){       
                    playerInstance.setup({
                        playlist: [{
                            "image": "https://cdn.jsdelivr.net/gh/bitmox/file@main/promintonx.png",
                            "title": _jsonData.nama_channel+" - Prominton", 
